...
item_check_table = {
    ITEM_CHECK_LOCATION_OFFSET + 13: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 13, task_id=0, name="Dark Jak",
        rule=lambda state, player: main_mission_table[2].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 18: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 18, task_id=0, name="Red Security Pass",
        rule=lambda state, player: main_mission_table[5].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 7:  Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 7,  task_id=0, name="Scatter Gun",
        rule=lambda state, player: main_mission_table[6].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 6:  Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 6,  task_id=0, name="Blaster",
        rule=lambda state, player: main_mission_table[9].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 30: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 30, task_id=0, name="Mountain Lens",
        rule=lambda state, player: main_mission_table[12].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 31: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 31, task_id=0, name="Mountain Gear",
        rule=lambda state, player: main_mission_table[13].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 32: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 32, task_id=0, name="Mountain Shard",
        rule=lambda state, player: main_mission_table[14].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 39: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 39, task_id=0, name="Gun Turret",
        rule=lambda state, player: main_mission_table[19].rule(state, player) or main_mission_table[29].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 20: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 20, task_id=0, name="Yellow Security Pass",
        rule=lambda state, player: main_mission_table[11].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 19: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 19, task_id=0, name="Green Security Pass",
        rule=lambda state, player: main_mission_table[15].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 14: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 14, task_id=0, name="Gun Speed Upgrade",
        rule=lambda state, player: main_mission_table[17].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 29: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 29, task_id=0, name="Air Train Pass",
        rule=lambda state, player: main_mission_table[26].rule(state, player) or main_mission_table[37].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 8:  Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 8,  task_id=0, name="Vulcan Fury",
        rule=lambda state, player: main_mission_table[24].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 10: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 10, task_id=0, name="JET-Board",
        rule=lambda state, player: main_mission_table[25].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 40: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 40, task_id=0, name="Seal Piece 1",
        rule=lambda state, player: main_mission_table[36].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 41: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 41, task_id=0, name="Seal Piece 2",
        rule=lambda state, player: main_mission_table[37].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 42: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 42, task_id=0, name="Seal Piece 3",
        rule=lambda state, player: main_mission_table[39].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 33: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 33, task_id=0, name="Ruby Key",
        rule=lambda state, player: main_mission_table[32].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 15: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 15, task_id=0, name="Gun Ammo Upgrade",
        rule=lambda state, player: main_mission_table[31].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 9:  Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 9,  task_id=0, name="Peacemaker",
        rule=lambda state, player: main_mission_table[45].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 38: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 38, task_id=0, name="Titan Suit",
        rule=lambda state, player: main_mission_table[50].rule(state, player) or main_mission_table[52].rule(state, player) or main_mission_table[59].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 37: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 37, task_id=0, name="Life Seed",
        rule=lambda state, player: main_mission_table[50].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 27: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 27, task_id=0, name="Purple Security Pass",
        rule=lambda state, player: main_mission_table[54].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 28: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 28, task_id=0, name="Black Security Pass",
        rule=lambda state, player: main_mission_table[55].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 16: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 16, task_id=0, name="Gun Damage Upgrade",
        rule=lambda state, player: main_mission_table[43].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 34: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 34, task_id=0, name="Heart of Mar",
        rule=lambda state, player: main_mission_table[43].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 35: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 35, task_id=0, name="Time Map",
        rule=lambda state, player: main_mission_table[58].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 43: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 43, task_id=0, name="Rift Rider",
        rule=lambda state, player: main_mission_table[61].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 36: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 36, task_id=0, name="Precursor Stone",
        rule=lambda state, player: main_mission_table[62].rule(state, player)),
    ITEM_CHECK_LOCATION_OFFSET + 22: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 22, task_id=0, name="Dark Bomb"),
    ITEM_CHECK_LOCATION_OFFSET + 23: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 23, task_id=0, name="Dark Blast"),
    ITEM_CHECK_LOCATION_OFFSET + 24: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 24, task_id=0, name="Dark Invincibility"),
    ITEM_CHECK_LOCATION_OFFSET + 25: Jak2MissionData(mission_id=ITEM_CHECK_LOCATION_OFFSET + 25, task_id=0, name="Dark Giant"),
}
